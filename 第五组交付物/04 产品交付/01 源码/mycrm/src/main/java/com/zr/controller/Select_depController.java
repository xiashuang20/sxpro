...
import com.zr.service.Select_depService;
...
public class Select_depController extends  HttpServlet{
	...
	Select_depService  select_depService   = new Select_depService();
	@Override
	...
	//	System.out.println(name);
		...
		int count1;
	            ...
	            if(dname!=null || dinfo!=null) {
	    			
	            	   users = select_depService.selectnotice(dname, dinfo);
	            	   
	    		}
	            else {
	              users = select_depService.selectnotice(pagess, rowss);
